    ...
    public partial class OgrenciIslemleri : Form
    {
        ...
        private void btn_ekle_Click(object sender, EventArgs e)
        {
          //BL'daki ogrenci_islem sınıfındaki ogr_ekle fonksiyonu çalıştırılarak öğrenci ekleme işlemi yapılır.
            int sonuc = islem.OgrenciEkle(txt_isim.Text, txt_soyad.Text, txt_dgmyeri.Text, txt_no.Text, cmb_cinsiyet.SelectedItem.ToString(), 
                txt_dgmtarihi.Text, txt_uyeliktarihi.Text,int.Parse (txt_sinif.Text), txt_telefon.Text,txt_email.Text, txt_adres.Text);
        ...
        private void btn_guncelle_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                int sonuc = islem.OgrenciGuncelle(int.Parse(txt_id.Text), txt_isim.Text, txt_soyad.Text, txt_dgmyeri.Text,txt_no.Text,
                    cmb_cinsiyet.Text,txt_dgmtarihi.Text,txt_uyeliktarihi.Text,int.Parse(txt_sinif.Text),txt_telefon.Text,txt_email.Text,txt_adres.Text);
