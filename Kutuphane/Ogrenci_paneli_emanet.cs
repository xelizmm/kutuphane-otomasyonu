...
namespace Kutuphane
{
    public partial class Ogrenci_paneli_emanet : Form
    {
        public Ogrenci_paneli_emanet()
        {
            InitializeComponent();
        }
        ...
        private void Txt_ogrno_Click(object sender, EventArgs e)
        {
            Txt_ogrno.Text = "";
        }
        ...
        private void Btn_tum_Click_1(object sender, EventArgs e)
        {
