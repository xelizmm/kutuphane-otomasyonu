...
namespace Kutuphane
{
    public partial class Kitap_grafik_ogrenci_paneli : Form
    {
        public Kitap_grafik_ogrenci_paneli()
        {
            InitializeComponent();
        }
        ...
        private void Kitap_grafik_ogrenci_paneli_Load(object sender, EventArgs e)
        {
