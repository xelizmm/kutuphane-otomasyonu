...
namespace Kutuphane
{
    public partial class KitapIslemleri : Form
    {
        ...
        private void Btn_ekle_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                int sonuc = Islem.KitapEkle(Txt_ktpadi.Text, Txt_no.Text, Txt_yazar.Text, Txt_yayinev.Text, 
                    Txt_ktptur.Text, int.Parse(Txt_stok.Text), int.Parse(Txt_sayfa.Text), int.Parse(Txt_basimyili.Text));
        ...
        private void Btn_guncelle_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                int Sonuc = Islem3.KitapGuncelle (int.Parse(Txt_ktpid.Text), Txt_ktpadi.Text, Txt_no.Text, 
                    Txt_yazar.Text,Txt_yayinev.Text,Txt_ktptur.Text,int.Parse(Txt_stok.Text) ,int.Parse(Txt_sayfa.Text), int.Parse(Txt_basimyili.Text));
